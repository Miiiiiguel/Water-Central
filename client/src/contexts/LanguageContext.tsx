...
export const translations = {
  es: {
    ...
    'header.inteligencia': 'Inteligencia de mercado',
    'header.roi': 'Calculadora ROI',
    'header.calculadora': 'Fletes',
  ...
  en: {
    ...
    'header.planes': 'Plans',
    'header.inteligencia': 'Market intelligence',
    'header.roi': 'ROI calculator',
    'header.calculadora': 'Freight',
